...
void NullMainWindow::setVisibleForAllElementsInPalette(const Id &metatype, bool visible)
{
	Q_UNUSED(visible)
}
...
void NullMainWindow::setEnabledForAllElementsInPalette(const Id &metatype, bool enabled)
{
	Q_UNUSED(enabled)
}
