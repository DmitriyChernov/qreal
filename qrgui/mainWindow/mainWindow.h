...
public:
	...
	void setVisibleForAllElementsInPalette(const Id &metatype, bool visible) override;
	void setElementInPaletteEnabled(const Id &metatype, bool enabled) override;
	void setEnabledForAllElementsInPalette(const Id &metatype, bool enabled) override;
